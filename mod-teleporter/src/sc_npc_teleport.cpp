...
bool TELE::IsAllowedToTeleport(Player * const player) const
{
    ...
    switch (m_catvalue.flag)
    {
      case FLAG_TEAM:
        switch (m_catvalue.data0)
        {
          case TEAM_HORDE:      return player->GetTeamId() == HORDE;
          case TEAM_ALLIANCE:   return player->GetTeamId() == ALLIANCE;
      ...
      default: sLog->outString("Invalid flag (category: %u). Important problem...", GetCatID());
    }

    sLog->outString("Invalid flag (category: %u). Important problem...", GetCatID());
    return false;
}
...
bool nsNpcTel::IsValidData(CatValue catvalue) //  const uint32 &cat, const Flag &flag, const uint64 &data0, const uint32 &data1
{
    switch (catvalue.flag)
    {
      case FLAG_TEAM:
        if (catvalue.data1)
            sLog->outString("Invalid data1 (category: %u).", catvalue.catid);
        if (catvalue.data0 < MAX_FLAG_TEAM)
            return true;
        sLog->outString("Invalid data0 (Team) (category: %u).", catvalue.catid);
        return false;
      ...
      case FLAG_GUILD:
        ...
        if (catvalue.data0)
            return true;
        sLog->outString("Invalid data0 (GuildID) (category: %u).", catvalue.catid);
        return false;
      ...
      case FLAG_GMLEVEL:
        ...
        if (0 < catvalue.data0 && catvalue.data0 < 256)
            return true;
        sLog->outString("Invalid data0 (GmLevel) (category: %u).", catvalue.catid);
        return false;

      case FLAG_ISGM:
        if (catvalue.data0)
            sLog->outString("Invalid data0 (category: %u).", catvalue.catid);
        if (catvalue.data1)
            sLog->outString("Invalid data1 (category: %u).", catvalue.catid);
        return true;
      ...
      case FLAG_ACCOUNT:
        ...
        if (catvalue.data0)
            return true;
        sLog->outString("Invalid data0 (AccountID) (category: %u).", catvalue.catid);
        return false;
     ...
     case FLAG_LEVEL:
        ...
        if (0 < catvalue.data0 && catvalue.data0 < 256)
            return true;
        sLog->outString("Invalid data0 (Level) (category: %u).", catvalue.catid);
        return false;

      case FLAG_ITEM:
        if (!catvalue.data0)
        {
            sLog->outString("Invalid data0 (ItemID) (category: %u).", catvalue.catid);
            return false;
        }
        if (catvalue.data1)
            return true;
        sLog->outString("Invalid data1 (Item Count) (category: %u).", catvalue.catid);
        return false;

      case FLAG_QUEST:
        if (!catvalue.data0)
        {
            sLog->outString("Invalid data0 (QuestID) (category: %u).", catvalue.catid);
            return false;
        }
        if (catvalue.data1 < MAX_QUEST_STATUS + 1)
            return true;
        sLog->outString("Invalid data1 (Quest Status) (category: %u).", catvalue.catid);
        return false;
      ...
      case FLAG_GENDER:
        ...
        if (catvalue.data0 < GENDER_NONE)
            return true;
        sLog->outString("Invalid data0 (Gender) (category: %u).", catvalue.catid);
        return false;
      ...
      case FLAG_RACE:
        ...
        if (0 < catvalue.data0 && catvalue.data0 < MAX_RACES)
            return true;
        sLog->outString("Invalid data0 (Race) (category: %u).", catvalue.catid);
        return false;
      ...
      case FLAG_CLASS:
        ...
        if (0 < catvalue.data0 && catvalue.data0 < MAX_CLASSES)
            return true;
        sLog->outString("Invalid data0 (Class) (category: %u).", catvalue.catid);
        return false;

      case FLAG_REPUTATION:
        if (!catvalue.data0)
        {
            sLog->outString("Invalid data0 (Faction/Reputation) (category: %u).", catvalue.catid);
            return false;
        }
        if (catvalue.data1 <= REP_EXALTED)
            return true;
        sLog->outString("Invalid data1 (Faction/Reputation) (category: %u).", catvalue.catid);
        return false;
      ...
      case FLAG_PLAYER:
        ...
        if (catvalue.data0)
            return true;
        sLog->outString("Invalid data0 (PlayerGuid) (category: %u).", catvalue.catid);
        return false;

      default: sLog->outString("Invalid flag (category: %u).", catvalue.catid);
    }

    sLog->outString("Invalid flag (category: %u).", catvalue.catid);
    return false;
}
...
void LoadNpcTele(void)
{
    ...
    if (result)
    {
        sLog->outString("Loading %s, %s and %s...", Table[0], Table[1], Table[2]);
        ...
        sLog->outString(" ");
        sLog->outString("Loaded %u npc_teleport.", nbDest);
    }
    else
        sLog->outString("WARNING >> Loaded 0 npc_teleport.");
}
