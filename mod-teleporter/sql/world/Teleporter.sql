...
INSERT IGNORE INTO npc_text_locale (ID) value (100000);
INSERT IGNORE INTO npc_text_locale (ID) value (100001);

UPDATE npc_text_locale
SET Text3_0="Wählt Eure Kategorie"
WHERE ID=100000;


UPDATE npc_text_locale
SET Text3_0="Wählt Euren Zielort"
WHERE ID=100001;

-- `creature_template`
DELETE FROM `creature_template` where entry=100000;
INSERT INTO `creature_template` (`entry`, `modelid1`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `speed_walk`, `speed_run`, `scale`, `rank`, `unit_class`, `unit_flags`, `unit_flags2`, `HoverHeight`, `HealthModifier`, `ManaModifier`, `ArmorModifier`, `DamageModifier`, `RegenHealth`, `flags_extra`, `ScriptName`) VALUES
(100000, 26502, 'TeleNPC2', 83, 83, 35, 1, 1, 1.14286, 2, 1, 1, 2, 2048, 1, 1, 1, 1, 1, 1, 2, 'npc_teleport');

SET @Id=8000;
DELETE FROM trinity_string WHERE entry BETWEEN @Id AND @Id+2;

INSERT INTO trinity_string (`entry`, `content_default`, `content_loc3`)
VALUES (@Id+0, "You do not have the required level. This destination requires level", "Ihr habt nicht das erforderliche Level. Dieses Ziel benötigt Level"),
