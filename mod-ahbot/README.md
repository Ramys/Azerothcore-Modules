...
```
1. Manually Apply ahbot.patch to your core.
...
If you need to change the module configuration (conf broken needs repair make changes in AuctionHouseBot.cpp manually) , go to your server configuration folder (where your `worldserver` or `worldserver.exe` is)
